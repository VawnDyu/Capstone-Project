...
<head>
    ...
    <title>Manage Account | About Me</title>
</head>
<body>
    <div class="main-container">
        ...
        <div class="account-navigator">
            <a href="#" class="a-active">About Me</a>
            <a href="OICChangePassword.php" class="a-inactive">Password</a>
        </div>
    ...
    <script>
        ...
        click.addEventListener("click", function() {
            for (var i=0;i<errormodal.length;i+=1) {
                ...
                window.history.pushState("Closing the modal", "Refresh", "OICManageAccount.php");
            }
        });
