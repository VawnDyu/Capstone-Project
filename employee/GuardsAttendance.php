...
<body>
    <div class="main-container">
        ...
        <a href="GuardsAttendanceViewAll.php"><span class="material-icons-outlined">account_circle</span>View</a>
        </div>
    ...
    <script>
        ...
        click.addEventListener("click", function() {
            for (var i=0;i<errormodal.length;i+=1) {
                ...
                window.history.pushState("Closing the modal", "Refresh", "GuardsAttendance.php");
            }
        });
