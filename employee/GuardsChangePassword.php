...
<body>
    <div class="main-container">
        ...
        <div class="account-navigator">
            <a href="GuardsManageAccount.php" class="a-inactive">About Me</a>
            <a href="GuardsChangePassword.php" class="a-active">Password</a>
        </div>
    ...
    <script>
        ...
        click.addEventListener("click", function() {
            for (var i=0;i<errormodal.length;i+=1) {
                ...
                window.history.pushState("Closing the modal", "Refresh", "GuardsChangePassword.php");
            }
        });
