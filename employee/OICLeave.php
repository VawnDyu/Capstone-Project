...
<head>
    ...
    <title>OIC | Apply for Leave</title>
</head>
<body>
    ...
    <div class="view-modal">  
        <form method="post" class="form-modal">
            <a href="OICLeave.php?msg=cancel"><span class="close">&times</span></a>
    ...
    <script>
        ...
        click.addEventListener("click", function() {
            for (var i=0;i<errormodal.length;i+=1) {
                ...
                window.history.pushState("Closing the modal", "Refresh", "OICLeave.php");
            }
        });
