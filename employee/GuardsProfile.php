    ...
    <div class="main-container">
        ...
        <div class="user-profile">
            ...
            <div class="manage-account">
                <a href="GuardsManageAccount.php"><span class="material-icons-outlined">manage_accounts</span>Manage Account</a>
            </div>
            ...
            <div class="user-info-content">
                ...
                <header>Shift: <?php echo $sessionData['shift']?></header>
            </div>
            ...
            <div class="user-contact">
                ...
                <div class="profile-edit">
                    <a href="GuardsManageAccount.php?msg=profile_edit">
