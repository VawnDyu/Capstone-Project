<?php 
    ...
    if (isset($_SESSION['admin_user']) && isset($_SESSION['admin_pass'])) {
        if (isset($_POST['restore'])) {
            ...
            $sql = "UPDATE employee SET isDeleted = ? WHERE id = ?";
...
<body>
    <div class="main-container">
        ...
        <div class="category">
            <a href="#">
                <div class="selected">Employee</div>
            </a>
            <a href="archive_secretary.php">
                <div>Secretary</div>
            </a>
            <a href="archive_company.php">
                <div>Company</div>
            </a>
        </div>

        <div class="list-of-secretary">
            <header>List of Employee</header>
            ...
            <table>
                ...
                <tbody>
                    <?php 
                        ...
                        $sql = "SELECT * FROM employee WHERE isDeleted = '1'";
                        $stmt = $payroll->con()->prepare($sql);
                        $stmt->execute();
        ...
        <div class="archive-count">
            <header>No. of Archived Employee</header>

            <div class="count">
                <header>
                    <?php 
                        $sql = "SELECT COUNT(isDeleted) FROM employee WHERE isDeleted = '1'";
                        $stmt = $payroll->con()->prepare($sql);
                        $stmt->execute();
    ...
    <script>
        ...
        cancelbtn.addEventListener("click", function() {
            window.location.href = "archive_employee.php";
        });
