...
<body>
    <div class="main-container">
        ...
        <div class="category">
            ...
            <a href="#">
                <div class="selected">Secretary</div>
            </a>
        ...
        <div class="list-of-secretary">
            <header>List of Secretary</header>
            ...
            <table>
                ...
                <tbody>
                    <?php 
                        ...
                        $sql = "SELECT * FROM secretary WHERE isDeleted = '1'";
                        $stmt = $payroll->con()->prepare($sql);
                        $stmt->execute();
        ...
        <div class="archive-count">
            <header>No. of Archived Secretary</header>

            <div class="count">
                <header>
                    <?php 
                        $sql = "SELECT COUNT(isDeleted) FROM secretary WHERE isDeleted = '1'";
                        $stmt = $payroll->con()->prepare($sql);
                        $stmt->execute();
    ...
    <script>
        ...
        cancelbtn.addEventListener("click", function() {
            window.location.href = "archive_secretary.php";
        });
